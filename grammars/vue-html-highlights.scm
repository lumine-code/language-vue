...
(("<" @punctuation.definition.tag.begin.html)
  (#is? test.childOfType "start_tag self_closing_tag"))
...
((tag_name) @entity.name.tag.html
  (#is? test.childOfType "start_tag end_tag self_closing_tag"))

(("</" @punctuation.definition.tag.begin.html)
  (#is? test.childOfType end_tag))

(("/>" @punctuation.definition.tag.end.html)
  (#is? test.childOfType self_closing_tag))
...
(["\"" "'"] @punctuation.definition.string.begin.html
  (#is? test.childOfType quoted_attribute_value)
  (#is? test.first true))
